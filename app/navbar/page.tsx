...
// const navigation = [
//     { name: 'Dashboard', href: '/', current: useRouter.pathname === '/' },
//     { name: 'Url Analysis', href: '/url', current: useRouter().pathname === '/url' },
//     { name: 'Code Analysis', href: '/code', current: useRouter().pathname === '/code' },
//     { name: 'About Us', href: '/about', current: useRouter().pathname === '/about' },
//   ]
// const navigation = [


//   { name: 'Dashboard', href: '#', current: true },
//   { name: 'Url Analysis', href: '/url', current: false },
//   { name: 'Code Analysis', href: '/code', current: false },
